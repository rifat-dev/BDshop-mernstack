...
export const singleOrderDetails = (state = { singleOrder: {}, loading: false, error: null }, action) => {
    switch (action.type) {
...
export const newOrder = (state = { loading: false, isCreated: false, error: null }, action) => {
    switch (action.type) {
